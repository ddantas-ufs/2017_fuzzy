...
/*****/
  fprintf(lista,"Metodo %d -> Tamanho %d, Jan: %dx%d, Val(x,y): %dx%d, TS: %d,  ", atoi(argv[2]), atoi(argv[3]), atoi(argv[5]), atoi(argv[6]), atoi(argv[7]), atoi(argv[8]), atoi(argv[9]) );
